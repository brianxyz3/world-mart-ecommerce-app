const Hero = () => {
    return (
        <>
            <main className="container text-gray-800 text-center mt-9">
                ...
                <div className="flex">
                    <img src="../src/assets/images/shopping-cart-1.avif" alt="a shopping cart filled with packages" className="w-1/5" />
                    <div className="flex flex-row items-center -mt-8 ms-auto w-1/2 -me-32">
